...
import { EditOutlined, OrderedListOutlined, TagsOutlined, QuestionOutlined, ChromeOutlined, FormOutlined } from '@ant-design/icons';
    ...
    return (
        <Fragment>
            ...
            <Row className='admin-index-row'>
                ...
                <Col className='admin-index-col' xs={24} sm={24} md={12} lg={12} >
                    <Link href='/admin/uploadArticle'><a><FormOutlined /><br />새로운 기사 올리기</a></Link>
                </Col>
                <Col className='admin-index-col' xs={24} sm={24} md={12} lg={12}>
