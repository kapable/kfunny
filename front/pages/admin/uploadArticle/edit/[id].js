...
const UploadArticle = () => {
    ...
    return (
        <Fragment>
            <Head>
                <title>기사 수정 | 케이퍼니</title>
                <meta charSet='utf-8'/>
                <link rel='main-url' href={`https://niair.xyz/admin/uploadArticle/edit/${1}`} />
                ...
                <meta property="og:url" content={`https://niair.xyz/admin/uploadArticle/edit/${1}`} />
                ...
                <meta property="twitter:url" content={`https://niair.xyz/admin/uploadArticle/edit/${1}`}/>
            ...
            <ArticleUploadEditor contents={singleArticle} isNewContents={false} />
        </Fragment>
    );
};
